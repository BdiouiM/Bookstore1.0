...
public class AuthentificationController implements Initializable {
    ...
    private void Login(ActionEvent event) {
        ...
        {
              try {
             FXMLLoader loader=new FXMLLoader(getClass().getResource("/bookstore/fx/offre/IU_Admin.fxml"));
        ...
        {
             try {
             FXMLLoader loader=new FXMLLoader(getClass().getResource("/bookstore/fx/offre/IU_Bibliothecaire.fxml"));
             Parent root1=(Parent) loader.load();
        ...
        else if (sa.clientAuthentification(user, pass))
        {
             ...
             try {
             FXMLLoader loader=new FXMLLoader(getClass().getResource("/bookstore/fx/offre/IU_Client.fxml"));
