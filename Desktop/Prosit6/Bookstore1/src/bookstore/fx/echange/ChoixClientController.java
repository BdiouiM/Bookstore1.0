 ...
 */
package bookstore.fx.echange;

import bookstore.fx.echange.MesEchangeClientController;
import java.net.URL;
...
public class ChoixClientController implements Initializable {
    ...
    private void IUclient1(ActionEvent event) {
        ...
        try {
             FXMLLoader loader=new FXMLLoader(getClass().getResource("/bookstore/fx/echange/ClientEchange.fxml"));
    ...
    private void IUclient2(ActionEvent event) {
        System.out.println("Client");
        try {
             FXMLLoader loader=new FXMLLoader(getClass().getResource("/bookstore/fx/echange/EnvoyerEchange.fxml"));
             Parent root1=(Parent) loader.load();
             Stage stage=new Stage();
             //stage.setTitle("second window");
             stage.setScene(new Scene(root1));
    ...
    private void IUclient3(ActionEvent event) {
        System.out.println("Client");
        try {
             FXMLLoader loader=new FXMLLoader(getClass().getResource("/bookstore/fx/echange/MesEchangeClient.fxml"));
             Parent root1=(Parent) loader.load();
             Stage stage=new Stage();
             //stage.setTitle("second window");
